...
import { getInterviewLogsByCompanyId } from "@/lib/mock-interview-logs";
import {
...
export default async function CompanyDetailPage({
  ...
  const interviewLogs = getInterviewLogsByCompanyId(company.id);
